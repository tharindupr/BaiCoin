...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Baicoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"35.184.60.29", "35.184.60.29"},
    {"149.248.0.26", "94.156.189.207"},
    {"3.15.180.133", "176.197.249.156"},
    {"34.66.124.6", "112.134.139.13"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Baicoin is probably already running."), addrBind.ToString().c_str());
        else
